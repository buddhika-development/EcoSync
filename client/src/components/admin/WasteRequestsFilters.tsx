...
interface WasteRequestsFiltersProps {
  selectedArea: string;
  onAreaChange: (area: string) => void;
}

// SOLID Principle: Single Responsibility - Only handles filter UI
// HCI Principle: Consistency and standards - Follows same filter pattern as Bins page
export default function WasteRequestsFilters({
  selectedArea,
  onAreaChange,
}: WasteRequestsFiltersProps) {
  return (
